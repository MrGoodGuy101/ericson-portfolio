...
document.getElementById('contact-form')
    .addEventListener('submit', function(event) {
        ...
        const templateID = 'template_7n178l2';
...
// <!-- emailjs to mail contact form data ends-->

document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Ericson Panes";
            $("#favicon").attr("href", "assets/images/GG Logo_favicon.png");
        }
        else {
...
var typed = new Typed(".typing-text", {
    strings: ["Software Development", "Web Development", "Web Design", "IT Automation", "Graphic Design"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
